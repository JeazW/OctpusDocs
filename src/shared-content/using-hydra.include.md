...
1. Download the latest Hydra NuGet package from [https://yamldoc.liuyan.wang/downloads/latest/Hydra](https://yamldoc.liuyan.wang/downloads/latest/Hydra).
...
3. Import the [Hydra step template](http://library.yamldoc.liuyan.wang/step-templates/d4fb1945-f0a8-4de4-9045-8441e14057fa/actiontemplate-hydra-update-octopus-tentacle) from the Community Library.
