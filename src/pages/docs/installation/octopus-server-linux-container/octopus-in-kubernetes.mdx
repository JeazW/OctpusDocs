  ...
  template:
    ...
    spec:
      ...
      - name: octopus        
        ...
        env:
          - name: ACCEPT_EULA
            # "Y" means accepting the EULA at https://yamldoc.liuyan.wang/company/legal
            value: "Y"
...
When running Octopus Server on Windows Server, to access the logs for an Octopus Server Node, you'd typically either log into the Server using Remote Desktop and access them locally, or you might [publish the logs to a centralized logging tool](https://help.yamldoc.liuyan.wang/t/how-can-i-configure-octopus-deploy-to-write-logs-to-a-centralized-logger-such-as-seq-splunk-or-papertrail/24551).
