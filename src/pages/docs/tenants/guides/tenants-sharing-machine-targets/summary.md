...
If you have any questions about this scenario, please reach out our [support team](https://yamldoc.liuyan.wang/support).
...
No, each tenant requires a separate task per deployment. If you always deploy to all tenants in a hosting group concurrently, it is worth considering another way of modeling your tenants. You can contact our [support team](https://yamldoc.liuyan.wang/support) for advice on how to model your scenario.
