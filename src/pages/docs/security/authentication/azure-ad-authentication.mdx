...
If you already have Octopus user accounts and you want to enable Azure Active Directory (AAD) authentication:
- Make sure the **Email Address** and **Username** values for Octopus user accounts are both identical.
- Confirm the Octopus user **Email Address** and **Username** are matched to the email address configured in Azure Active Directory (AAD).

This will maximize the chance for your existing users to sign in using Azure Active Directory (AAD) and prevent duplicate Octopus user accounts from being created.
:::
...
If you aren't able to resolve the authentication problems yourself using these troubleshooting tips, please reach out to our [support team](https://yamldoc.liuyan.wang/support) with:
