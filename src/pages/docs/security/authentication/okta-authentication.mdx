...
:::
   ...
   ![](/docs/security/authentication/okta/okta-initiate-login.png "width=500")
...
:::figure
![](/docs/security/authentication/okta/okta-openid-token.png "width=500")
:::
...
:::figure
![Okta Groups claim](/docs/security/authentication/okta/okta-groups-claim-type.png "width=500")
:::
...
6. If you are not able to figure out what is going wrong, please send a copy of the decoded payload to our [support team](https://yamldoc.liuyan.wang/support) and let them know what behavior you are experiencing.
