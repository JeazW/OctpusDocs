...
The Octopus CLI is a command line tool that builds on top of the [Octopus Deploy REST API](https://yamldoc.liuyan.wang/docs/octopus-rest-api). With the Octopus CLI, you can push your application packages for deployment as either zip or NuGet packages, and manage your environments, deployments, projects, and workers.
...
For more information see [Octopus Command Line (CLI)](https://yamldoc.liuyan.wang/docs/octopus-rest-api/cli).
