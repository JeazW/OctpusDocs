...
- Automatic upgrades to the latest version of Octopus, including improvements, bug fixes, security enhancements, and [new features](https://yamldoc.liuyan.wang/whatsnew) before they’re released on Octopus Server. 
...
When you’re ready, [start a free trial](https://yamldoc.liuyan.wang/start) to explore Octopus.
...
If you’d like to move an existing Octopus Cloud instance to one of the other regions or request a new region, please [contact us](https://yamldoc.liuyan.wang/company/contact).
...
If you think you will exceed these thresholds, please [contact our Sales team](https://yamldoc.liuyan.wang/company/contact).

Please see our [Cloud pricing FAQ](https://yamldoc.liuyan.wang/pricing/faq#are-there-any-storage-limits) for further details.

## Learn more
- [Octopus Cloud pricing FAQs](https://yamldoc.liuyan.wang/pricing/faq#are-there-any-differences-between-cloud-and-server)
- [Octopus pricing page](https://yamldoc.liuyan.wang/pricing/overview)
...
- [Octopus Cloud blog posts](https://yamldoc.liuyan.wang/blog/tag/octopus%20Cloud)
- [Trust center](https://yamldoc.liuyan.wang/company/trust)
