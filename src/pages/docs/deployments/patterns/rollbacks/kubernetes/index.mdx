...
Database rollbacks are out of scope for this guide; refer to this [article](https://yamldoc.liuyan.wang/blog/database-rollbacks-pitfalls), which discusses methods of database rollbacks and when they are appropriate.
