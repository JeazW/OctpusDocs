...
- Automate routine maintenance and respond faster to emergencies:
  - Octopus [runbooks](https://yamldoc.liuyan.wang/docs/runbooks/) and [projects](https://yamldoc.liuyan.wang/docs/projects) share the same variables and accounts to interact with your clusters
  - Use pre-approved [kubectl](https://yamldoc.liuyan.wang/docs/deployments/kubernetes/kubectl) scripts
...
- Familiarize yourself with 3 fundamental Octopus concepts: [projects](https://yamldoc.liuyan.wang/docs/projects), [environments](https://yamldoc.liuyan.wang/docs/infrastructure/environments), and [targets](https://yamldoc.liuyan.wang/docs/infrastructure/deployment-targets). When you have time, you can learn about other Octopus concepts in our [glossary](https://yamldoc.liuyan.wang/docs/getting-started/glossary).
...
- Release triggers [link] and [channels](https://yamldoc.liuyan.wang/docs/releases/channels) to automate deployments
- [Step templates](https://yamldoc.liuyan.wang/docs/projects/custom-step-templates) to create new pipelines with ease
- [Configuration as Code](https://yamldoc.liuyan.wang/docs/projects/version-control) to manage deployment pipeline versions
- [Users, roles, and teams](https://yamldoc.liuyan.wang/docs/getting-started/best-practices/users-roles-and-teams)
- Maintenance tasks with [runbooks](https://yamldoc.liuyan.wang/docs/runbooks/) and [scripts](https://yamldoc.liuyan.wang/docs/deployments/kubernetes/kubectl)

## Learn more
- Learn more about [Kubernetes deployments with Octopus](https://yamldoc.liuyan.wang/use-case/kubernetes)
- How to choose between [Kubernetes deployment targets](https://yamldoc.liuyan.wang/docs/infrastructure/deployment-targets/kubernetes-target)
- [Learn more about Kubernetes](https://yamldoc.liuyan.wang/blog/search?context=blog&q=kubernetes) on our blog
