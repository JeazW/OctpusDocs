...
- apt.yamldoc.liuyan.wang
- rpm.yamldoc.liuyan.wang
...
- [Archive](https://yamldoc.liuyan.wang/downloads/latest/Linux_x64TarGz/OctopusTentacle)
- [APT](https://yamldoc.liuyan.wang/downloads/latest/Linux_x64Apt/OctopusTentacle)
- [RPM](https://yamldoc.liuyan.wang/downloads/latest/Linux_x64Rpm/OctopusTentacle)
...
# for Raspbian use
# sh -c "echo 'deb https://apt.yamldoc.liuyan.wang/ buster main' >> /etc/apt/sources.list"
# apt-get update
...
```bash
wget https://rpm.yamldoc.liuyan.wang/tentacle.repo -O /etc/yum.repos.d/tentacle.repo
...
wget https://yamldoc.liuyan.wang/downloads/latest/Linux_$($arch)TarGz/OctopusTentacle -O tentacle-linux_$($arch).tar.gz
#or
