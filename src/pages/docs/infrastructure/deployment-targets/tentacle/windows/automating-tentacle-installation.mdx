...
The latest Tentacle MSI can always be [downloaded from the Octopus Deploy downloads page](https://yamldoc.liuyan.wang/downloads).

Permalinks to always get the latest MSIs are:

- 32-bit: [https://yamldoc.liuyan.wang/downloads/latest/WindowsX86/OctopusTentacle](https://yamldoc.liuyan.wang/downloads/latest/WindowsX86/OctopusTentacle)
- 64-bit: [https://yamldoc.liuyan.wang/downloads/latest/WindowsX64/OctopusTentacle](https://yamldoc.liuyan.wang/downloads/latest/WindowsX64/OctopusTentacle)
