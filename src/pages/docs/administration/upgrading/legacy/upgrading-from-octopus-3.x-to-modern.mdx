...
- Raised the [minimum requirements for hosting and using Octopus Server](https://yamldoc.liuyan.wang/blog/raising-minimum-requirements-for-octopus-server) (both Windows and SQL Server).
...
See the [Release Notes](https://yamldoc.liuyan.wang/downloads/compare?from=3.3.27&amp;to=3.4.0) for breaking changes and more information.
