...
- Linux is supported when using the [Octopus Deploy Linux Docker image](https://yamldoc.liuyan.wang/blog/introducing-linux-docker-image)
...
We are currently working with our existing customers on what best practices look like to self-host the Octopus Server Linux Container.  If you'd like further recommendations please [contact us](https://yamldoc.liuyan.wang/support).
