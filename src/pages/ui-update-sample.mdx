...
:::figure
![Octopus Deploy Tenant variable dashboard](/docs/getting-started/tenant-variables.png)
:::
...
:::figure
![Octopus Deploy screen to edit a Tenant variable](/docs/projects/variables/images/tenant-variables-edit.png)
:::
...
:::figure
![Octopus Deploy Library variable sets screen](/docs/getting-started/library-variable-sets.png)
:::
...
:::figure
![Octopus Deploy Common Variables screen](/docs/projects/variables/images/variable-templates-project-template.png)
:::

## Older versions

- In versions earlier than 2024.2, you'll find the page for Tenant Variables under the Projects menu -> Tenant Variables
